import { getMockColorThemes, fetchColorThemes2 } from "@/app/api/get-colors3";
...
export default async function Page({ params }: { params: { name: string } }) {
	...
	const matchedThemes = await fetchColorThemes2(params.name, null);

    return (
			<>
				{matchedThemes.map((theme: Theme, id: number) => (
